...
const CONVOS = [
  ...
  {
    id:30, avatar:"💛", name:"lea.girard", sub:"Friend · Lyon",
    unread:false, time:"3 weeks ago", section:null,
    ...
    messages:[
      ...
      { from:"me",   text:"lea I can't do this anymore", time:"09:41" },
      ...
      { from:"me",   text:"lea can I come to your place next weekend", time:"09:54" },
      ...
      { from:"me",   text:"thank you lea really", time:"10:02" },
      ...
      { from:"me",   text:"lea I think I'm going to go to my aunt's", time:"10:05" },
  ...
  },
  {
    ...
    preview:"did you see the comment L. left on your photo",
    messages:[
      { from:"them", text:"did you see the comment L. left on your photo?", time:"20:12" },
