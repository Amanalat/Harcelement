const WA_DATA = {
  ...
  messages: [
    ...
    { id:  1, sender: "Lucas",  text: "guys this is so funny, clara tried to talk to us again at break 💀",                    time: "17:14", delay:  800 },
    ...
    { id:  6, sender: "Lucas",  text: "like 3 weeks and she still doesn't get it lol",                                         time: "17:17", delay:  700 },
    { id:  7, sender: "Jade",   text: "I'm sick of seeing her post stuff on insta like nothing happened",                      time: "17:17", delay:  900 },
    { id:  8, sender: "Lucas",  text: "yeah she acts like everything's fine when no one talks to her at school",               time: "17:18", delay: 1000 },
    ...
    { id: 11, type: "system",         text:   "Lucas shared an Instagram post", time: "17:21", delay: 1500 },
    { id: 12, type: "instagram-card", sender: "Lucas",                          time: "17:21", delay:  600 },
    { id: 13, sender: "Lucas",  text: "EVERYONE GO NOW this is the moment 🔥🔥",                                          time: "17:21", delay:  600 },
    ...
    { id: 18, sender: "Lucas",  text: "I'm using @utilisateur_4729, I've had it for a while",                            time: "17:23", delay:  900 },
    ...
    { id: 23, sender: "Lucas",  text: "yeah leave pauses between each one so it looks natural",                           time: "17:26", delay:  900 },
    ...
    { id: 26, sender: "Lucas",  text: "we managed to contaminate her image 😈",                                          time: "17:52", delay:  800 },
    { id: 27, sender: "Kevin",  text: "seriously don't you think we're going a bit too far now...",                       time: "17:53", delay: 1000 },
    { id: 28, sender: "Lucas",  text: "don't worry it's just for fun, she takes it way too seriously anyway",             time: "17:53", delay:  900 },
    ...
    { id: 31, sender: "Lucas",  text: "yes with anon accounts again, so she can't sleep peacefully",                      time: "17:55", delay:  900 },
    ...
    { id: 34, sender: "Lucas",  text: "I created @anonymous_x0 just for her btw",                                        time: "17:57", delay:  700 },
    ...
    { id: 38, sender: "Lucas",  text: "so she thinks about us even at home, even when she's trying to sleep 💀",         time: "18:00", delay: 1000 },
    ...
    { id: 41, sender: "Lucas",  text: "hahaha we really broke her 💀",                                                   time: "09:15", delay:  700 },
    ...
    { id: 45, sender: "Lucas",  text: "relax she just needs a break, she brought it on herself 😂",                       time: "09:17", delay:  700 },
    ...
    { id: 49, sender: "Lucas",  text: "her WHAT 💀💀💀",                                                                 time: "09:20", delay:  500 },
    ...
    { id: 53, sender: "Lucas",  text: "lmao she ran away to her secret castle 🏰 so pathetic",                           time: "09:22", delay:  800 },
    ...
    { id: 57, sender: "Lucas",  text: "well she can come back from her \"haven\" whenever she wants 😂 we'll be here",    time: "09:25", delay:  900 },
  ...
  navigation: {
    ...
    next: { label: "Continue: Convince Clara →", url: "4_Convaincre_Clara_en.html" }
  }
